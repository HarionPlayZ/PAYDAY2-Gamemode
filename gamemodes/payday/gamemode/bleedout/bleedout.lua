...
local convar19 = GetConVar( "bleedout_legacyui" )
local convar20 = GetConVar( "bleedout_view_roll" )
local convar21 = GetConVar( "bleedout_draw_revive_timer" )
local convar22 = GetConVar( "bleedout_notarget" )
local convar23 = GetConVar( "bleedout_reducedmg" ) --3
local convar24 = GetConVar( "bleedout_moving_enable" )
local convar25 = GetConVar( "bleedout_npc_can_revive" )
